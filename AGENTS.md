...
- Use unit tests when they clearly earn their keep, especially for pure parsing, small deterministic algorithms, error mapping, or cases that are expensive or flaky to cover through integration tests.
